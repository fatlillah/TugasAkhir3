  ...
  <div class="content-wrapper" id="app">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update Data Matakuliah</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="container">
        <form action="/updateMatkul/{{$data->id}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="mb-3">
            <label for="nama" class="form-label">ID Matakuliah</label>
            <input type="text" class="form-control" id="namaid" placeholder="Masukkan ID matkul" name="id_matkul" value="{{$data->id_matkul}}">
          </div>
          <div class="mb-3">
            <label for="nama" class="form-label">Matakuliah</label>
            <input type="text" class="form-control" id="namaid" placeholder="Masukkan matakuliah" name="Nama_matkul" value="{{$data->Nama_matkul}}">
          </div>
          <div class="mb-3">
            <label for="nama" class="form-label">Nama Dosen</label>
            <input type="text" class="form-control" id="namaid" placeholder="Masukkan nama dosen" name="Nama_Dosen" value="{{$data->Nama_Dosen}}">
          </div>
          <div class="mb-3">
            <label for="nama" class="form-label">SKS</label>
            <input type="text" class="form-control" id="namaid" placeholder="Masukkan SKS" name="SKS" value="{{$data->SKS}}">
          </div>
