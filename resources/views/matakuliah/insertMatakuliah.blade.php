  ...
  <div class="content-wrapper" id="app">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Insert Data Matakuliah</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container">
        <form action="/addMatakuliah" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="matakuliah" placeholder="Masukkan ID matkul" name="id_matkul">
          </div>
          <div class="mb-3">
            <label for="nama" class="form-label">Matakuliah</label>
            <input type="text" class="form-control" id="matkul" placeholder="Masukkan matakuliah" name="Nama_matkul">
          </div>
          <div class="mb-3">
            <label for="nama" class="form-label">Nama Dosen</label>
            <input type="text" class="form-control" id="dosen" placeholder="Masukkan nama dosen" name="Nama_Dosen">
          </div>
          <div class="mb-3">
            <label for="nama" class="form-label">SKS</label>
            <input type="text" class="form-control" id="sks" placeholder="Masukkan SKS" name="SKS">
          </div>
